...
class CreateClassVC: PlugViewController {
    ...
    override func viewDidLoad() {
        ...
        self.bottomAction = {
            ...
            FBLogger.shared.log(id: "signUpClassname_classNameInput", param: ["name" : name])
            FBLogger.shared.log(id: "signUpClassname_classYearInput", param: ["year" : year])
            FBLogger.shared.log(id: "signUpClassname_nextBtn_toSignUpInvitCode")
            self.play()
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "next" {
            ...
            vc.bottomAction = {
                FBLogger.shared.log(id: "signUpCreateInvitCode_nextBtn_toChatMain")
                vc.play()
